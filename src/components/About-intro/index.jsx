        ...
        <div className="row">
          ...
          <div className="col-lg-8 offset-lg-1 col-md-8">
            <div className="text">
             ...
             <br/>  <br/><b>Quality Assurance: </b> At TradEdge, quality is our top priority. We meticulously select our export products, ensuring they meet the highest industry standards. From the sourcing process to the final delivery, we maintain stringent quality control measures, guaranteeing that you receive products of exceptional quality.

             <br/>  <br/><b>Customer Satisfaction: </b> We firmly believe that our success is rooted in the success of our clients. We strive to build long-lasting relationships based on trust, reliability, and exceptional service. Your satisfaction is our driving force, and we go the extra mile to exceed your expectations at every step of the export journey.
                </p>
              </Split>
            </div>
          </div>
